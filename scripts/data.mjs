...
export const workExperience = [
  {
    company: "Plastic Goose, LLC",
    location: "Remote",
    role: "Project Management, Systems Solution Engineer",
  ...
  {
    role: "Petty Officer Second Class - Sonar Supervisor",
  ...
  {
    role: "Petty Officer Third Class - Sonar Technician",
  ...
  {
    role: "Seaman - Sonar Technician",
    date: "Jul 2013-Dec 2014",
  },
  {
    company: "Polycraft, Inc.",
    location: "Temecula, CA",
    role: "Head of Art Department",
    date: "Jan 2009-Jul 2013",
    bullets: [
